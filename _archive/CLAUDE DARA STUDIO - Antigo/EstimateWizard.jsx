  ...
  return (
    <div className="wz-animate">
      ...
      <div style={{ display: "flex", gap: 12 }}>
        ...
        <button className="wz-btn-ghost" style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", gap: 8 }}>
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto", padding: "36px 24px 80px" }}>
          <div style={{
            ...
            <div style={{ maxWidth: showSidebar ? "none" : 660, margin: showSidebar ? 0 : "0 auto" }}>
              ...
              {step === 8 && <Step9 data={data} estimate={estimate} />}

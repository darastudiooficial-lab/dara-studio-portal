...
const AdminLogin = () => {
  ...
  const handleGoogleLogin = async () => {
    ...
    if (error) { toast.error("Erro ao entrar com Google"); setIsLoading(false); }
  };
    ...
    <div className="min-h-screen flex items-center justify-center bg-muted/30">
      <div className="w-full max-w-sm mx-auto px-4">
        ...
        <div className="text-center mb-8">
          <img src={daraLogo} alt="DARA Studio" className="h-14 w-14 rounded-lg mx-auto mb-4" />
          <h1 className="font-serif text-lg font-semibold text-primary">
            <span className="font-bold">DARA Studio</span> | Drafting & 3D Support
          </h1>
            ...
            <form onSubmit={form.handleSubmit(handleLogin)} className="space-y-4">
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input type="email" className="pl-10" placeholder="admin@darastudio.com" {...form.register("email")} />
                </div>
              </div>
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input type="password" className="pl-10" placeholder="••••••••" {...form.register("password")} />
                </div>
              </div>

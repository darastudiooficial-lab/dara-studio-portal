/**
 * DARA Studio — Unified Server
 * Serves the frontend HTML + handles email API routes.
 *
 * Setup:
 *   1. Place dara-studio-unified.html in this same folder
 *   2. cp .env.example .env  →  fill GMAIL_USER + GMAIL_APP_PASSWORD
...
/* ── Serve frontend ── */
const HTML_FILE = path.join(__dirname, "dara-studio-unified.html");

    ...
    <div className="lp-root services-page-root">
      ...
      <main className="independent-page" style={{ 
        ...
        <div style={{ maxWidth: '1400px', margin: '0 auto 40px', width: '100%', padding: '0 60px', zIndex: 20, position: 'relative' }}>
          <div style={{
            background: 'rgba(161, 130, 74, 0.08)',
            ...
            <span style={{ fontSize: '28px', color: '#8F723E', filter: 'drop-shadow(0 0 10px rgba(161, 130, 74, 0.4))' }}>
            ...
            <div style={{ 
              ...
              {lang === "EN" ? (
                <>
                  ...
                  <span style={{ color: '#8F723E', fontWeight: '800', fontStyle: 'normal' }}>$150,000</span>{" "}

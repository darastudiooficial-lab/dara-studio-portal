    ...
    <div className="landing-wrapper">
      ...
      <main className="hero-section">
        ...
        <div className="action-buttons animate-float-up delay-400">
          ...
          <button className="glass-pill" onClick={() => navigate("/login")}>
            {T.accessPortal}
          </button>
        </div>
        ...
        <div className="trust-cluster animate-float-up delay-500">
          ...
          <div className="trust-bar">
            ...
            <div className="trust-bar-logos">
              <div className="software-logo-item" title="Chief Architect">
                ...
                <span className="software-logo-text">Chief Architect</span>
              </div>
              ...
              <div className="software-logo-item has-tooltip" title="US Code Compliant">
                ...
                <span className="software-logo-text">US CODE COMPLIANT</span>
                <div className="tooltip-content">
                  Projects developed according to IBC, IRC, and local municipal standards for seamless permit approval.
                </div>
              </div>
            </div>
            ...
            <div className="trust-bar-badges">
              <div className="trust-badge">CAU SC A115105-3 — Licensed Architect · Brazil</div>
              <div className="trust-badge">Architectural Drafter · United States</div>
              <div className="trust-badge">
                <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ marginRight: '6px', verticalAlign: 'middle' }}><rect x="3" y="11" width="18" height="11" rx="2" ry="2"></rect><path d="M7 11V7a5 5 0 0 1 10 0v4"></path></svg>

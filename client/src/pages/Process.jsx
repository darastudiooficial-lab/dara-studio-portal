  ...
  return (
    <div className="lp-root">
      ...
      <main className="independent-page">
        <BackButton />
        <section className="workflow-section" style={{ padding: 0, background: 'none' }}>
          <div className="workflow-intro">
            <span style={{ fontSize: 11, color: "var(--a)", fontWeight: 700, letterSpacing: ".2em", textTransform: "uppercase" }}>Workflow</span>
            <h2 style={{ marginTop: 12 }}>{lang === "EN" ? "How We Work" : "Como Trabalhamos"}</h2>
            <p>{lang === "EN" ? "We follow a structured, fully remote digital workflow — no in-person meetings. All coordination happens via WhatsApp and our client portal." : "Seguimos um fluxo de trabalho digital estruturado e totalmente remoto — sem reuniões presenciais. Toda a coordenação acontece via WhatsApp e nosso portal do cliente."}</p>
          </div>

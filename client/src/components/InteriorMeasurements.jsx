      ...
      <div style={{ 
        ...
        <div style={{ display: 'flex', gap: '24px', alignItems: 'center', flexWrap: 'wrap' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px', fontSize: '13px', color: 'var(--mu)' }}>
            ...
            <span style={{ border: '1px solid #10b981', color: '#10b981', padding: '2px 6px', borderRadius: '4px', fontSize: '10px', fontWeight: 'bold' }}>IBC</span> {lang === 'EN' ? 'Commercial' : 'Comercial'}
            ...
            return (
              <button 
                ...
                style={{
                  ...
                  border: isActive ? '1px solid #ec4899' : '1px solid var(--glass-border)',
                  color: isActive ? '#ec4899' : 'var(--mu)',
                  padding: '6px 16px',
                  borderRadius: '999px',
                  fontSize: '13px',
                  cursor: 'pointer',

...
const html = daraConfirmationEmail(testData);
const scratchDir = path.join(__dirname, 'scratch');
if (!fs.existsSync(scratchDir)) fs.mkdirSync(scratchDir);

fs.writeFileSync(path.join(scratchDir, 'test_email.html'), html);
console.log("HTML generated at server/scratch/test_email.html");
